...
date: 2021-08-06
image: ../../assets/images/works/korfbal_trainer.png
image_alt: Korfbal Trainer Live App
...
This way I have no need for a database, because frankly this application doesn't really need one _yet_.
...
<FlexCenter>
  <Button href="https://github.com/nlxdodge/korfbal-trainer" icon="mdi:github">Korfbal Trainer Repository</Button>
  <Button href="https://korfbal-trainer.netlify.app/" icon="ph:link-bold">Korfbal Trainer App</Button>
</FlexCenter>
