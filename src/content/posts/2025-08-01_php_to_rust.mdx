...
So I need: 
- A Docker/Kubernetes environment to run the Rust Application (or just a native VM).
- An HTTP server to serve the Vue front-end Application.
- An e-mail server to send e-mails for sign-up.
